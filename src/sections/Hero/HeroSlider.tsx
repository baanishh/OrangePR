          ...
          return (
            ...
            >
              <div className="relative w-full max-w-[1536px] mx-auto px-4 xs:px-6 xs-sm:px-8 md-lg:px-12 pt-25 xs:pt-30 md:pt-45 pb-15 xs:pb-20 flex-1 flex flex-col justify-center z-10 h-full">
                ...
                <div
                  className={`absolute right-4 sm:right-8 md-lg:right-12 bottom-37 w-[340px] xl:w-[425px] hidden laptop:block z-20 transition-all duration-1000 delay-150 ${
                    isActive
                      ? "opacity-100 translate-y-0"
                ...
                >
                  <div className="relative p-2 w-full rounded-md overflow-hidden border-2 border-white/50 shadow-lg bg-white/40 backdrop-blur-[10px] aspect-4/3">
                    ...
                    >
                      <span className="flex h-20 w-20 xl:h-25 xl:w-25 items-center justify-center rounded-full bg-white/60 backdrop-blur-[20px]">
                        <FeatherIcon
                          icon="play"
